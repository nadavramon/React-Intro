...
import { AuthenticatedRequest } from '../types/user.ts';

export function getTasks(req: AuthenticatedRequest, res: Response, next: NextFunction): void {
  try {
...
export function getTaskById(req: AuthenticatedRequest, res: Response, next: NextFunction): void {
  try {
...
export function createTask(req: AuthenticatedRequest, res: Response, next: NextFunction): void {
  try {
...
export function updateTask(req: AuthenticatedRequest, res: Response, next: NextFunction): void {
  try {
    const { id } = req.params;
...
export function deleteTask(req: AuthenticatedRequest, res: Response, next: NextFunction): void {
  try {
